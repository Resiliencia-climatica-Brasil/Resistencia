...
A atribuição dos valores de resistência para cada classe de uso e cobertura do solo e a combinação das diferentes bases de dados corresponde à **Etapa 4** da análise conectividade local (@fig-flux4).
