...
Iniciamos a atribuição dos valores de resistência na camada de uso e cobertura do solo do MapBiomas com resolução de 90 m, conforme valores apresentados na @tbl-2.
<!-- COMO COLOCAMOS ESSES VALORES DENTRO DAS NOSSAS CAMADAS? -->
<!-- 
ADICIONAR TABELA 1 APENAS COM OS VALORES DE RESISTÊNCIA PARA AS 29 CLASSES DO MAPBIOMAS
06/03/2024 --Feito 
 -->
...
: Valores de resistência, por bioma, para as 39 classes de uso e cobertura do solo, resultado da combinação das superfícies de uso e cobertura do solo do MapBiomas. { #tbl-2 }

A esse conjunto de dados, acrescentamos uma coluna na tabela de atributos, com as 4 classes de largura dos corpos d'água, conforme valores apresentados na @tbl-3. 
<!-- ADICIONAR TABELA 2 APENAS COM OS VALORES DE RESISTÊNCIA PARA AS 4 CLASSES DE LARGURA DOS CORPOS D'ÁGUA
06/03/2024 --Feito 
 --> 
...
: Valores de resistência, por bioma, para as quatro classes de tamanho dos rios (N: 29 - 32). { #tbl-3 }

Por fim, atribuímos à camada de infraestrutura de transporte e de energia, os valores de resistência e combinamos o resultado à camada anterior (conforme descrito no item anterior).

As camadas *raster* geradas para as bases de dados de infraestrutura de transporte e de energia receberam valores de resistência como atributo específico, conforme indicado na @tbl-4. 
<!-- ADICIONAR TABELA 3 APENAS COM OS VALORES DE RESISTÊNCIA PARA AS CLASSES DE INFRA DE TRANSPORTE E DE ENERGIA 
06/03/2024 --Feito 
 -->
...
: Valores de resistência, por bioma, para as camada de infraestrutura de transporte e de energia (N: 33 - 39). {#tbl-4}
...
O mapa consolidado dos valores de resistência para cada uso e cobertura do solo @fig-5, combinando as classes de largura dos corpos d'água e as classes de infraestrutura de transporte e de energia, totalizou 39 classes  @tbl-1.
