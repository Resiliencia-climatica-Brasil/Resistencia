...
Iniciamos a atribuição dos valores de resistência na camada de uso e cobertura do solo do MapBiomas reamostrada na resolução de 90 m, conforme valores apresentados na @tbl-2.
...
: Valores de resistência, por bioma, para as 28 classes de uso e cobertura do solo (sem a classe de águas abertas), obtidas da base de dados de uso e cobertura do solo do MapBiomas. { #tbl-2 }
