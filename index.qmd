...
#Marina: Não entendi essa frase: "A reamostragem foi realizada pelo **método de vizinho mais próximo** (*nearest neighbor*) já que essa superfície é composta por 27 valores categóricos do uso e cobertura do solo", uma vez que a reamostragem dos pixels de 30 para 90 metros independem do número de classes que temos no MapBiomas#
