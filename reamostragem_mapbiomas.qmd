...
![Método da reamostragem da superfície de uso e cobertura do solo (MapBiomas coleção 8 de 2021), de 30 m para 90 m, por meio da técnica NEAREST, no ArcGis 10.5.](figs/Figura_3.2.jpg.png){width=100% #fig-1}

![Classificação do uso e cobertura do solo convertida de uma resolução de 30 m para 90 m, tomando como base MapBiomas, coleção 8 de 2023.](figs/map1_mapbiomas.png){width=100% #fig-map-1}
