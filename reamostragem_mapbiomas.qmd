...
A reamostragem da base de dados do MapBiomas corresponde à **Etapa 1** da análise de conectividade local.
...
![Classificação do uso e cobertura do solo convertida de uma resolução de 30 m para 90 m, tomando como base MapBiomas, coleção 8 de 2023.](figs/map1_mapbiomas.png){width=100% #map1mapbiomas}
