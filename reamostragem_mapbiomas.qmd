...
A reamostragem da base de dados do MapBiomas corresponde à **Etapa 1** da análise de conectividade local (Figura 1).

<!-- 2024-03-06 INSERIR FIGURA: fluxograma_etapa1
LEGENDA: Fluxograma com a indicação da Etapa 1 da análise de conectividade local: reamostragem do MapBiomas.
-->
